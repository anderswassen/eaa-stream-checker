      ...
      >
        ...
        <motion.section variants={fadeUp} className="glass rounded-2xl p-6 sm:p-8 space-y-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            The <strong className="text-slate-300">European Accessibility Act (EAA)</strong>, formally
            Directive (EU) 2019/882, establishes binding accessibility requirements for products and
            services across the European Union. As of <strong className="text-slate-300">28 June 2025</strong>,
            all digital services covered by the Act — including audio-visual media services and streaming
            platforms — must comply with the harmonised European standard <strong className="text-slate-300">EN 301 549</strong>.
          </p>
          <p className="text-sm text-slate-400 leading-relaxed">
          ...
          <div className="grid sm:grid-cols-2 gap-4 pt-2">
            <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-4 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-slate-200">Clause 7 — Video &amp; Streaming</h3>
              </div>
            ...
            <div className="rounded-xl bg-slate-800/50 border border-slate-700/50 p-4 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-semibold text-slate-200">Clause 9 — Web Content</h3>
              </div>
              <ul className="text-xs text-slate-400 space-y-1 ml-9 list-disc">
