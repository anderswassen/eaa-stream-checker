...
All player controls must meet accessibility standards: proper ARIA labelling (7.4.1), visible focus indicators (7.4.2), sufficient colour contrast (7.4.3), and adequate touch target sizes (7.4.4).`},{heading:"Clause 9: Web Content (WCAG 2.2 AA)",content:`Clause 9 requires all web content to meet WCAG 2.2 Level AA. For streaming services, this applies to every page: the homepage, browse/search interfaces, account management, subscription flows, and the video player page itself. Key areas include:
