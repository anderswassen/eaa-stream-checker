const t=[{slug:"eaa-streaming-compliance",title:"EAA Compliance for Streaming Services: The Complete Guide",metaTitle:"EAA Compliance for Streaming Services — Complete 2026 Guide",metaDescription:"Complete guide to European Accessibility Act compliance for streaming platforms. Learn what the EAA requires for video services, EN 301 549 Clause 7 obligations, enforcement timelines, and how to audit your streaming platform.",intro:"The European Accessibility Act (EAA) has fundamentally changed the compliance landscape for streaming services across Europe. Since the enforcement deadline of 28 June 2025, every streaming platform, OTT service, and video-on-demand provider serving EU customers must meet the accessibility requirements defined in EN 301 549. This guide explains exactly what the EAA means for streaming services, what you need to do, and how to verify compliance.",sections:[{heading:"What Is the European Accessibility Act?",content:`The European Accessibility Act (Directive 2019/882) is EU legislation that establishes binding accessibility requirements for products and services. It was adopted in 2019 and member states were required to transpose it into national law by 28 June 2022. The compliance deadline for services — including streaming platforms — was 28 June 2025.
...
Unlike the Web Content Accessibility Guidelines (WCAG) alone, the EAA requires compliance with the full EN 301 549 standard, which goes well beyond web content accessibility to include specific requirements for video playback, captions, audio description, and player controls.`},{heading:"Who Must Comply?",content:`The EAA applies to any economic operator providing services to consumers in the EU. For streaming, this includes:
...
The key factor is whether the service is available to EU consumers. Even platforms headquartered outside Europe must comply if they serve EU markets. Microenterprises (fewer than 10 employees and turnover under €2 million) are exempt, but most streaming services exceed these thresholds.`},{heading:"EN 301 549: The Technical Standard",content:`EN 301 549 is the harmonised European standard for ICT accessibility. When the EAA says services must be "accessible," EN 301 549 defines exactly what that means in technical terms. For streaming services, two sections are critical:
...
The combination of Clause 7 and Clause 9 means streaming services face a dual compliance burden that most generic accessibility tools don't fully address.`},{heading:"Clause 7 Requirements in Detail",content:`Clause 7 of EN 301 549 establishes requirements that are specific to video and media services. Here are the key obligations:
...
**DRM Compatibility (7.5)**: Digital Rights Management must not prevent access to accessibility features. Captions and audio description must remain functional regardless of content protection.`},{heading:"How to Audit Your Streaming Platform",content:`A comprehensive EAA compliance audit for streaming involves several layers:
...
EAA Stream Checker automates steps 1–5 for your web-based player. Paste a URL and get a full EN 301 549 compliance report in 30 seconds — covering both Clause 7 (video) and Clause 9 (web content) requirements.`},{heading:"Enforcement and Penalties",content:`The EAA requires member states to establish market surveillance authorities and define penalties that are "effective, proportionate, and dissuasive." Penalties vary significantly by country:
...
Enforcement is ramping up throughout 2026 as national authorities establish their processes and begin responding to complaints. The transition period for services that were already in use before June 2025 extends to June 2030, but new services and significant updates must comply immediately.`},{heading:"Getting Started with Compliance",content:`If you're starting your EAA compliance journey for a streaming service, here's a practical roadmap:
...
7. **Document compliance**: Export VPAT 2.5 EU Edition reports for regulatory submissions and procurement requirements.`}],relatedSlugs:["en-301-549-streaming","eaa-fines","subtitles-captions-eaa"]},{slug:"en-301-549-streaming",title:"EN 301 549 for Streaming Media: Technical Requirements",metaTitle:"EN 301 549 Streaming Requirements — Clause 7 & 9 Explained",metaDescription:"Technical deep-dive into EN 301 549 requirements for streaming services. Clause 7 video accessibility, Clause 9 web content, HLS/DASH manifest requirements, and automated compliance testing.",intro:"EN 301 549 is the European harmonised standard that defines the technical accessibility requirements for ICT products and services. For streaming media, it imposes specific obligations across two key clauses: Clause 7 for video capabilities and Clause 9 for web content. This guide breaks down every relevant requirement and explains how to test for compliance.",sections:[{heading:"Understanding EN 301 549",content:`EN 301 549 (full title: "Accessibility requirements for ICT products and services") is maintained by ETSI, CEN, and CENELEC. It serves as the presumption-of-conformity standard for the European Accessibility Act — meaning that if your service meets EN 301 549, you are presumed to comply with the EAA's accessibility requirements.
...
Clause 7, however, has no WCAG equivalent. These requirements are unique to media services and require specialised testing that most accessibility tools don't provide.`},{heading:"Clause 7: Video Capabilities — Full Breakdown",content:`**7.1 — Caption Processing Technology**
...
All player controls must meet accessibility standards: proper ARIA labelling (7.4.1), visible focus indicators (7.4.2), sufficient colour contrast (7.4.3), and adequate touch target sizes (7.4.4).`},{heading:"Clause 9: Web Content (WCAG 2.1 AA)",content:`Clause 9 requires all web content to meet WCAG 2.1 Level AA. For streaming services, this applies to every page: the homepage, browse/search interfaces, account management, subscription flows, and the video player page itself. Key areas include:
...
Automated tools can reliably detect approximately 30-40% of WCAG violations. For streaming services, the most common issues are missing alt text on promotional images, insufficient contrast on UI elements, missing form labels, keyboard traps in custom player controls, and missing language declarations.`},{heading:"HLS and DASH Manifest Requirements",content:`Streaming manifests (HLS .m3u8 and DASH .mpd) are where accessibility features are declared at the delivery level. Proper manifest configuration ensures that captions and audio description reach the player.
...
EAA Stream Checker intercepts HLS and DASH manifests during scanning and parses them to verify the presence and correct signalling of subtitle and audio description tracks.`},{heading:"Testing EN 301 549 Compliance",content:`Testing EN 301 549 for streaming services requires a combination of automated and manual methods:
...
The recommended approach is to use automated testing as a baseline screening tool — catching the majority of issues quickly and cheaply — then focus manual testing effort on the areas that automation cannot fully assess.`}],relatedSlugs:["eaa-streaming-compliance","hls-accessibility","audio-description-eaa"]},{slug:"hls-accessibility",title:"HLS Accessibility: Making HTTP Live Streaming Compliant",metaTitle:"HLS Accessibility Compliance — Captions, Audio Description & EN 301 549",metaDescription:"How to make HLS streams accessible and EAA compliant. Configure subtitle tracks, audio description, manifest signalling, and adaptive bitrate accessibility for EN 301 549 compliance.",intro:"HTTP Live Streaming (HLS) is the dominant streaming protocol, used by most major platforms and CDNs. Making your HLS streams accessible and compliant with EN 301 549 requires specific configuration at the manifest, encoding, and player levels. This guide covers everything you need to know about HLS accessibility.",sections:[{heading:"HLS and Accessibility: The Basics",content:`HLS delivers video content as a series of small segments described by playlist files (.m3u8). The master playlist lists available quality levels, audio tracks, and subtitle tracks. For accessibility compliance, the manifest must properly declare caption and audio description tracks so players can offer them to users.
...
Many streaming services deliver video with HLS but fail to properly configure these accessibility features in their manifests. The content may exist on the origin server but never reach the player because the manifest doesn't declare it.`},{heading:"Configuring Subtitle Tracks in HLS",content:`Subtitles and captions in HLS are declared using the #EXT-X-MEDIA tag with TYPE=SUBTITLES. A properly configured subtitle track looks like this:
...
Caption file formats: HLS supports WebVTT natively. WebVTT files should be segmented (split into small chunks matching the video segment duration) for live streaming, or served as a single file for VOD. TTML/IMSC can also be used with appropriate packaging.`},{heading:"Audio Description in HLS",content:`Audio description in HLS is delivered as a separate audio track in the manifest. The track should be clearly identified so players and assistive technologies can find it:
...
Common mistakes: Providing audio description as a separate stream URL rather than an alternative audio track in the same manifest. This breaks player UI integration and makes the track harder to discover.`},{heading:"Adaptive Bitrate and Accessibility",content:`HLS adaptive bitrate (ABR) streaming delivers multiple quality levels. A critical EN 301 549 requirement is that accessibility features remain available at all quality levels, including the lowest bitrate.
...
Both variants reference the same "subs" and "audio" groups, ensuring accessibility features are consistent.`},{heading:"Testing HLS Accessibility",content:`EAA Stream Checker intercepts HLS manifests during page scanning and analyses them for accessibility compliance. The automated checks include:
...
5. Verify CHARACTERISTICS attributes are present`}],relatedSlugs:["en-301-549-streaming","subtitles-captions-eaa","audio-description-eaa"]},{slug:"eaa-fines",title:"EAA Fines and Penalties: What Non-Compliance Costs",metaTitle:"EAA Fines & Penalties by Country — European Accessibility Act Enforcement 2026",metaDescription:"European Accessibility Act fines and penalties by EU member state. Learn what non-compliance costs for streaming services, enforcement timelines, and how to avoid penalties with compliance auditing.",intro:'The European Accessibility Act requires member states to establish "effective, proportionate, and dissuasive" penalties for non-compliance. With the enforcement deadline passed in June 2025, market surveillance authorities across Europe are now actively processing complaints and conducting inspections. This guide details the penalty frameworks across major EU markets.',sections:[{heading:"How EAA Enforcement Works",content:`The EAA establishes a decentralised enforcement model. Each EU member state is responsible for:
...
- Mandate third-party accessibility audits`},{heading:"Penalties by Country",content:`**Germany** (BFSG — Barrierefreiheitsstärkungsgesetz)
...
Fines: On conviction, fines up to €65,000 and/or imprisonment up to 18 months for responsible officers.`},{heading:"Beyond Fines: Other Risks",content:`Financial penalties are only one dimension of the risk. Non-compliance with the EAA also creates:
...
**Competitive disadvantage**: As awareness grows, consumers — particularly those with disabilities and their families — will increasingly choose accessible services. Accessibility is becoming a market differentiator.`},{heading:"The Transition Period",content:`The EAA includes a transition period for services that were already in use before 28 June 2025. These services have until 28 June 2030 to achieve full compliance. However, this transition applies only to existing services — any new service launched after June 2025, or any significant update to an existing service, must comply immediately.
...
In practice, most streaming services undergo frequent updates and redesigns, which means the transition period offers limited protection. The safest approach is to begin compliance efforts now rather than relying on the transition period.`},{heading:"How to Protect Your Service",content:`The most cost-effective approach to avoiding EAA penalties is proactive compliance:
...
The cost of a compliance programme is a fraction of potential fines — let alone the reputational and legal costs of enforcement action. A single scan with EAA Stream Checker takes 30 seconds and provides a comprehensive starting point.`}],relatedSlugs:["eaa-streaming-compliance","en-301-549-streaming","subtitles-captions-eaa"]},{slug:"subtitles-captions-eaa",title:"Subtitle and Caption Requirements Under the EAA",metaTitle:"EAA Subtitle & Caption Requirements — EN 301 549 Compliance Guide",metaDescription:"Complete guide to subtitle and caption requirements under the European Accessibility Act. EN 301 549 Clause 7.1 obligations, WebVTT/TTML standards, synchronisation, customisation, and automated testing.",intro:"Captions and subtitles are the most visible accessibility feature of any streaming service — and the most commonly tested by enforcement authorities. The European Accessibility Act, through EN 301 549 Clause 7.1, establishes detailed requirements for caption provision, synchronisation, preservation, customisation, and live delivery. This guide covers everything streaming providers need to know.",sections:[{heading:"Captions vs Subtitles: What the EAA Requires",content:`The terms "captions" and "subtitles" are often used interchangeably, but they serve different purposes. EN 301 549 uses the term "captions" to encompass both:
...
The key requirement is that captions must be provided for all pre-recorded content with audio. "All content" means not just main programming — it includes trailers, previews, bonus content, and any other video content on the platform.`},{heading:"EN 301 549 Clause 7.1 Explained",content:`Clause 7.1 of EN 301 549 establishes five specific requirements for captions:
...
**7.1.5 — Spoken Subtitles / Live Captions**: Live content requires real-time captioning. This may use human captioners (highest quality), automated speech recognition (ASR), or a hybrid approach. The key requirement is that captions are available during the live broadcast, not just after the fact.`},{heading:"Caption File Formats and Quality",content:`Several caption file formats are used in streaming. Each has strengths and limitations:
...
- Synchronisation: Timestamps align with expected audio timing`},{heading:"Caption Customisation Requirements",content:`EN 301 549 clause 7.1.4 requires user control over caption presentation. This is about more than offering on/off toggle — users must be able to adjust how captions look.
...
The customisation UI itself must be accessible — keyboard operable, with proper ARIA labels, sufficient contrast, and logical focus order. This creates a recursive requirement: the controls for making captions accessible must themselves be accessible.`},{heading:"Live Captioning",content:`Live streaming presents unique caption challenges. EN 301 549 clause 7.1.5 requires that live content with audio provides real-time captions. Options include:
...
EAA Stream Checker detects live streams (via manifest analysis and page indicators) and checks whether real-time caption tracks are being delivered.`},{heading:"Testing Caption Compliance",content:`EAA Stream Checker automates caption compliance testing across multiple dimensions:
...
To test your captions, scan your streaming URL with EAA Stream Checker. The report will show exactly which EN 301 549 Clause 7.1 requirements pass, fail, or need manual review — with evidence and remediation guidance for each finding.`}],relatedSlugs:["eaa-streaming-compliance","hls-accessibility","audio-description-eaa"]},{slug:"audio-description-eaa",title:"Audio Description Requirements Under the European Accessibility Act",metaTitle:"Audio Description Requirements — EAA & EN 301 549 Compliance Guide",metaDescription:"Guide to audio description requirements under the European Accessibility Act. EN 301 549 Clause 7.2 obligations, HLS/DASH implementation, testing tools, and compliance verification for streaming services.",intro:"Audio description (AD) provides a narrated description of important visual information in video content, enabling blind and low-vision users to understand what is happening on screen. The European Accessibility Act, through EN 301 549 Clause 7.2, requires streaming services to support audio description. This guide explains the requirements, implementation options, and how to verify compliance.",sections:[{heading:"What Is Audio Description?",content:`Audio description is an additional audio track that describes visual elements that are essential to understanding the content. It fills the gaps between dialogue with descriptions of:
...
According to the European Blind Union, approximately 30 million people in Europe are blind or have a visual impairment. Audio description is not a niche feature — it serves a significant and growing user base.`},{heading:"EN 301 549 Clause 7.2 Requirements",content:`Clause 7.2 establishes three requirements for audio description:
...
This is the same principle as caption preservation (7.1.3). Encoding, transcoding, CDN delivery, and manifest generation must not strip or lose audio description tracks. This is a common compliance failure — AD tracks exist at the origin but are not included in the streaming manifest.`},{heading:"Implementing Audio Description in Streaming",content:`There are several approaches to delivering audio description in streaming:
...
</AdaptationSet>`},{heading:"Content Creation and Prioritisation",content:`Creating audio description is a content production process that requires skilled writers and voice artists. For streaming services with large content libraries, describing every piece of content immediately may not be feasible. A practical prioritisation approach:
...
The EAA does not specify a percentage of content that must have AD — it requires that the platform supports AD playback and that AD is provided where available. However, a good-faith effort to expand AD coverage demonstrates compliance commitment and reduces enforcement risk.`},{heading:"Testing Audio Description Compliance",content:`EAA Stream Checker automates audio description compliance testing at the technical level:
...
To test your service, paste your streaming URL into EAA Stream Checker. The EN 301 549 Clause 7.2 section of the report will show exactly what was detected, what's missing, and what needs manual review.`}],relatedSlugs:["eaa-streaming-compliance","subtitles-captions-eaa","en-301-549-streaming"]}];function s(i){return t.find(e=>e.slug===i)}function n(i){return i.map(e=>t.find(a=>a.slug===e)).filter(e=>!!e)}export{n as a,t as b,s as g};
